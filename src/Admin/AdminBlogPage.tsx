...
const cardClass =
  "rounded-2xl border border-[var(--border-1)] bg-[var(--surface-1)] shadow-[0_12px_40px_var(--accent-soft)] p-4";
...
const AdminBlogPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--app-bg)] theme-text-1 p-4 md:p-8">
      <ToastContainer position="top-right" />
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-bold inline-flex items-center gap-2">
              <NotebookPen className="text-[var(--accent-1)]" size={28} />
              Blog Studio
            </h1>
          </div>
          <ThemeToggleButton />
        ...
        <section className={cardClass}>
          <BlogSection confirmAction={confirmAction} />
        </section>
      </div>
